...
public:
	akTransformState(const akVector3& oloc = akVector3(0,0,0),
                     ...
                     const akVector3& oscl = akVector3(1.0f,1.0f,1.0f))
	{

//        DBG("akTransformState::akTransformState \n");
		loc = oloc;
		rot = orot;
		scale = oscl;
	}
	...
	{
//        DBG("akTransform3 toTransform3 \n");
        akTransform3 t3(rot, loc);
#if 0
        static akVector3 mscale = akVector3(0.8f,0.8f,1.0f);
        return appendScale(t3, mscale);
#else
