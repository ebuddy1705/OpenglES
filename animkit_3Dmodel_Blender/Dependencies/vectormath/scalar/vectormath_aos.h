...
public:
    ...
    inline Vector3 & transY_GLES( float y ){
         setX(y);
    };
    inline Vector3 & scaleY_GLES( float y ){
         setX(y);
    };
    ...
    inline Vector3 & transZ_GLES( float z ){
         setY(-z);
    };
    inline Vector3 & scaleZ_GLES( float z ){
         setY(z);
    };
    ...
    inline Vector3 & transX_GLES( float x ){
         setZ(-x);
    };
    inline Vector3 & scaleX_GLES( float x ){
         setZ(x);
    };
